...
Promise.all(
  [
      ...
      db.query(`CREATE TABLE IF NOT EXISTS demo(
          id INT AUTO_INCREMENT PRIMARY KEY,
          lat DECIMAL(8,6), lng DECIMAL(8,6), type VARCHAR(32), address VARCHAR(32), img VARCHAR(256)
      )`),
      db.query(`CREATE TABLE IF NOT EXISTS demo1(
          id INT AUTO_INCREMENT PRIMARY KEY,
          img VARCHAR(256),
          name  VARCHAR(32),
          price DECIMAL(7,5),
          priceValue VARCHAR(32)
      )`)
